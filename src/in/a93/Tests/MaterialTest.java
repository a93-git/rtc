...
public class MaterialTest {
	...
	public static void phongReflectionTest() {
		...
		Color result = Material.getLighting(material, light, position, ev, nv);
		...
		Color result2 = Material.getLighting(material, light2, position, ev2, nv2);
		...
		Color result3 = Material.getLighting(material, light3, position, ev3, nv3);
		...
		Color result4 = Material.getLighting(material, light4, position, ev4, nv4);
		...
		Color result5 = Material.getLighting(material, light5, position, ev5, nv5);
